#include "oscillator/payload_storage.hpp"
#include "video/encoder/video_encoder.hpp"
#include <cstring>
#include <mutex>
#include <thread>

payload_storage::payload_storage(video_encoder *encoder, binary_semaphore *ready_request, binary_semaphore *ready_response, binary_semaphore *get_frame_request) {
    _encoder = encoder;
